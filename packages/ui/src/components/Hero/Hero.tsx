        ...
        <Box sx={{
            ...
            <Box sx={{
                ...
                <Typography variant='h6' sx={{
                    ...
                    {settings?.hero?.description || "Serving the community for over 30 years with the finest selection of plants, trees, and expert gardening advice"}
                </Typography>
                    ...
                    {(settings?.hero?.buttons || [
                        ...
                        <Button
                            ...
                            sx={{
                                ...
                                fontSize: "1.1rem",
                                fontWeight: 700,
                                backgroundColor: button.type === "primary" ? undefined : "rgba(255, 255, 255, 0.95)",
                                color: button.type === "primary" ? undefined : palette.primary.main,
                                border: button.type === "primary" ? undefined : "2px solid rgba(255, 255, 255, 0.95)",
                                boxShadow: "0 4px 14px 0 rgba(0,0,0,0.4)",
                                textTransform: "uppercase",
                                letterSpacing: "0.05em",
                                "&:hover": {
                                    backgroundColor: button.type === "primary" ? undefined : "white",
