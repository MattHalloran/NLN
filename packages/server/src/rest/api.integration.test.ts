...
describe('REST API Integration Tests', () => {
    ...
    beforeEach(async () => {
        ...
        const tables = [
            'order_item', 'order', 'feedback', 'customer_roles', 'email', 'phone',
            'customer', 'address', 'business_discounts', 'business', 'role',
            'sku_discounts', 'plant_trait', 'plant_images', 'sku', 'plant',
            'discount', 'image_file', 'image_labels', 'image', 'queue_task'
        ];
