...
export interface updateOrder_updateOrder_items_sku_plant_traits {
  __typename: "PlantTrait";
  name: string;
  value: string;
}

export interface updateOrder_updateOrder_items_sku_plant_images_image_files {
...
export interface updateOrder_updateOrder_items_sku_plant_images_image {
  __typename: "Image";
  hash: string;
  alt: string | null;
  description: string | null;
  files: updateOrder_updateOrder_items_sku_plant_images_image_files[] | null;
}

export interface updateOrder_updateOrder_items_sku_plant_images {
  __typename: "PlantImage";
  index: number;
  isDisplay: boolean;
  image: updateOrder_updateOrder_items_sku_plant_images_image;
}

export interface updateOrder_updateOrder_items_sku_plant {
  __typename: "Plant";
  id: string;
  latinName: string;
  traits: updateOrder_updateOrder_items_sku_plant_traits[] | null;
  images: updateOrder_updateOrder_items_sku_plant_images[] | null;
}
...
export interface updateOrder_updateOrder_items_sku {
  ...
  price: string | null;
  status: SkuStatus;
  plant: updateOrder_updateOrder_items_sku_plant;
