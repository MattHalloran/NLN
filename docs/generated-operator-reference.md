...
| `audit:github-deployment-governance` | release-governance | advanced | `external-read-only` |
| `audit:local-sensitive-permissions` | security | internal | `local-read-only` |
...
| `validate:phase11-adoption-policy` | release-governance | internal | `local-read-only` |
| `validate:phase11-ci-rehearsals` | release-governance | internal | `local-read-only` |
| `validate:phase9-disaster-recovery-policy` | disaster-recovery | internal | `local-read-only` |
| `rehearse:disaster-recovery` | disaster-recovery | advanced | `local-fixture-mutation` |
| `qualify:phase9-disaster-recovery` | disaster-recovery | advanced | `local-read-only` |
...
| `qualify:runtime-state-application-restore` | backup | advanced | `local-fixture-mutation` |
