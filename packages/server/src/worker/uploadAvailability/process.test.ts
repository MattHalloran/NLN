...
const mockPlantData = [
    ...
    },
    {
        ...
        traits: [{ id: "t3", name: "Trait3", value: "Value3" }],
    },
];
const mockPlantIds = mockPlantData.map((plant) => plant.id);

describe("upsertPlantData", () => {
    let prismaMock: any; // TODO: Add proper PrismaClient mock type
...
const createMockRow = (latinName: string, commonName: string) => {
    const row: any[] = [];
