...
import { OrdersInput, OrderStatus, SkuStatus } from "./globalTypes";
...
export interface orders_orders_items_sku_plant_traits {
  __typename: "PlantTrait";
  name: string;
  value: string;
}

export interface orders_orders_items_sku_plant_images_image_files {
...
export interface orders_orders_items_sku_plant_images_image {
  __typename: "Image";
  hash: string;
  alt: string | null;
  description: string | null;
  files: orders_orders_items_sku_plant_images_image_files[] | null;
}

export interface orders_orders_items_sku_plant_images {
  __typename: "PlantImage";
  index: number;
  isDisplay: boolean;
  image: orders_orders_items_sku_plant_images_image;
}

export interface orders_orders_items_sku_plant {
  __typename: "Plant";
  id: string;
  latinName: string;
  traits: orders_orders_items_sku_plant_traits[] | null;
  images: orders_orders_items_sku_plant_images[] | null;
}
...
export interface orders_orders_items_sku {
  ...
  price: string | null;
  status: SkuStatus;
  plant: orders_orders_items_sku_plant;
