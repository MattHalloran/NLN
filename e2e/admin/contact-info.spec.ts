...
test.describe("Admin Contact Info - Business Hours", () => {
  ...
  test("should update hours and verify preview immediately", async ({ authenticatedPage: _authenticatedPage }) => {
    // Set hours
...
test.describe("Admin Contact Info - Special Notes", () => {
  ...
  test("should add multiple notes", async ({ authenticatedPage: _authenticatedPage }) => {
...
test.describe("Admin Contact Info - Complex Scenarios", () => {
  ...
  test("should handle weekend hours differently from weekdays", async ({ authenticatedPage: _authenticatedPage }) => {
    // Set weekday hours
    await contactPage.setDayHours("Monday", "8:00 AM", "6:00 PM");
  ...
  test("should preserve special characters in notes", async ({ authenticatedPage: _authenticatedPage }) => {
