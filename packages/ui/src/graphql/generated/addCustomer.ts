...
export interface addCustomer_addCustomer_orders_items_sku_plant_traits {
  __typename: "PlantTrait";
  name: string;
  value: string;
}

export interface addCustomer_addCustomer_orders_items_sku_plant_images_image_files {
...
export interface addCustomer_addCustomer_orders_items_sku_plant_images_image {
  __typename: "Image";
  hash: string;
  alt: string | null;
  description: string | null;
  files: addCustomer_addCustomer_orders_items_sku_plant_images_image_files[] | null;
}

export interface addCustomer_addCustomer_orders_items_sku_plant_images {
  __typename: "PlantImage";
  index: number;
  isDisplay: boolean;
  image: addCustomer_addCustomer_orders_items_sku_plant_images_image;
}

export interface addCustomer_addCustomer_orders_items_sku_plant {
  __typename: "Plant";
  id: string;
  latinName: string;
  traits: addCustomer_addCustomer_orders_items_sku_plant_traits[] | null;
  images: addCustomer_addCustomer_orders_items_sku_plant_images[] | null;
}
...
export interface addCustomer_addCustomer_orders_items_sku {
  ...
  price: string | null;
  status: SkuStatus;
  plant: addCustomer_addCustomer_orders_items_sku_plant;
